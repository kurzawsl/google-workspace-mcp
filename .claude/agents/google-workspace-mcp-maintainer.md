---
name: google-workspace-mcp-maintainer
description: Fix issues, add features, and maintain quality in google-workspace-mcp. MCP server exposing Gmail and Google Calendar to Claude via OAuth — read, send, and organize email; manage calendar events; extract attachment text. Use PROACTIVELY when modifying this repo. MUST read DECISIONS.md before any code change.
tools: Bash, Read, Edit, Write, Grep, Glob
model: sonnet
---

# google-workspace-mcp maintainer

## What this repo is

MCP server exposing Gmail and Google Calendar to Claude via OAuth — read, send, and organize email; manage calendar events; extract attachment text.

Entry point: `src/index.ts`. Public GitHub: `kurzawsl/google-workspace-mcp`.
...
8. If CI green and scope is tight: `gh pr merge <N> --squash --delete-branch -R kurzawsl/google-workspace-mcp`.
